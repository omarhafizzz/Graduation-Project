...
apt-get update -y
apt-get upgrade -y
apt-get install -y curl wget gnupg2 software-properties-common apt-transport-https ca-certificates socat conntrack ipset
...
echo "========== [6/6] Initialize Kubernetes cluster =========="
...
echo "========== Untaint master (single-node) =========="
...
echo "========== KUBECONFIG (copy this to Jenkins) =========="
